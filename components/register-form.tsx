...
export default function RegisterForm() {
  ...
  useEffect(() => {
    const value =
      new URLSearchParams(window.location.hash.slice(1)).get("convite") || "";
      ...
      <section className="setup-card">
        ...
        {done ? (
          <>
            ...
            <p>Agora é só entrar com o e-mail e a senha que você escolheu.</p>
          ...
          <>
            ...
            {!ready ? (
              <p role="status">Preparando cadastro…</p>
            ) : !token ? (
              <p className="error-message" role="alert">
                Abra o link de convite que você recebeu. Ele contém a chave
                necessária para criar sua conta.
              </p>
            ) : (
            ...
            <p className="login-note">
              Já tem conta? <Link href="/login">Entre por aqui</Link>.
            </p>
          </>
        )}
      </section>
